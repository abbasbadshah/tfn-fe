          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-8 text-lg-end">
              <div className="social-style-four mb-20 wow fadeInLeft delay-0-2s animated">
                ...
                <a href="#">
                  <i className="fab fa-linkedin" /> <span>Linked In</span>
                </a>
                <a href="#">
            ...
            <div className="footer-left-content pt-80">
              ...
              <div className="footer-contact-info wow fadeInUp delay-0-3s animated">
                <a
                  ...
                  href="mailto:info@thefuturenow.com"
                >
                  info@thefuturenow.com <i className="far fa-arrow-right" />
                </a>
                <a
                  className="theme-btn style-three phone-number"
                  href="callto:9926028543"
                >
                  +91 9926028543 <i className="far fa-arrow-right" />
                </a>
              </div>
            </div>
          </div>
